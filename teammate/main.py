...
class MainWindow(Screen):
    ...
    def refresh(self):
        ...
        #self.ids.main_text.text = "remains " + usersheet.acell('K3').value +  ' kcal'
        self.ids.target_kcal_shown.text = 'Target: ' + usersheet.acell('L2').value +  ' kcal'
        self.ids.consumed_kcal_shown.text = 'Consumed: ' + usersheet.acell('K2').value + ' kcal'
...
class SecondWindow(Screen):
    ...
    def save(self, text):
        ...
        usersheet.insert_row(valuelist, row=1, value_input_option='USER_ENTERED')
        mains = self.manager.get_screen("main")
        mains.ids.consumed_kcal_shown.text = "Consumed: " + str(usersheet.acell('K2').value) + " kcal"
...
class FifthWindow(Screen):
    ...
    def press(self):
        ...
        mains = self.manager.get_screen("main")
        mains.ids.target_kcal_shown.text = "Target: " + str(usersheet.acell('L2').value) + " kcal"
        # mains.ids.main_text.text = str(usersheet.acell('K2').value) + '//' + str(usersheet.acell('L2').value) 
        # + ' kcal, remains ' + str(int(usersheet.acell('L2').value) - int(usersheet.acell('K2').value)) + ' kcal to consume'
        self.target.text = ""
...
kv = Builder.load_file('my_gui.kv')
